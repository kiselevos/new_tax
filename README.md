...
Сервис для расчёта подоходного налога в России. Подходит для сотрудников, HR и разработчиков, которым нужен точный программируемый расчёт.
...
- Прогрессивная шкала НДФЛ (пять ставок: 13%, 15%, 18%, 20%, 22%)
- Три типа занятости: трудовой договор (ТД), договор ГПХ, самозанятость (НПД)
- Стандартные налоговые вычеты (на детей и другие льготы)
