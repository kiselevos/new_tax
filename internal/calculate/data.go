...
// Константы для режима НПД (налог на профессиональный доход, самозанятые).
// Источник: Федеральный закон № 422-ФЗ от 27.11.2018.
const (
	NpdIncomeLimit           = 2_400_000_00 // Лимит дохода 2 400 000 ₽ в копейках
	NpdRegistrationDeduction = 1_000_000    // Регистрационный вычет 10 000 ₽ в копейках
	NpdRateIndividual        = 4            // Ставка 4% для доходов от физических лиц
	NpdRateLegal             = 6            // Ставка 6% для доходов от юридических лиц и ИП
)
